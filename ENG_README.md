...
Cyber Path is a terminal-based puzzle game featuring a procedural engine where robots must navigate a grid to reach targets. The core challenge lies in the "sliding" physics: robots move in a straight line until they hit an obstacle (a wall or another robot).
...
*Note: This project is optimized for Unix-based systems (Linux/macOS) to handle terminal rendering correctly.*
